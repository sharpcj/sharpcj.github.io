...
date:  2026-05-13 23:13:36 +0800
categories: ["技术", "编程", "AI应用工程化"]
tag: ["AI Agent", "Harness Engineering", "软件工程"]
image:
  path: /assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/cover.png
...
![AI Agent 的四个结构性缺陷](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/structural-defects.png)

---

# 二、核心洞察：能力上限取决于模型，质量下限取决于流程

这是一个关键的认知转换。

![核心范式转换](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/paradigm-shift.png)
...
![四层递进防线](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/four-layers.png)

## 3.1 第一层：Rules — 告诉它"什么必须做"
...
## 3.3 第三层：Agents + Workflow — 让它不能自己给自己放行
...
## 3.4 第四层：Scripts — 退出码说了算，Agent 说了不算
...
![三段式研发流程与三档 Profile](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/dev-process.png)
...
# 五、需求描述的革命：从"口头描述"到"可验证的结构化规范"

Harness 在需求描述上做了一件很巧妙的事：**OpenSpec R/S 体系**。

## 5.1 Requirement：用 SHALL 说话
...
## 5.2 Scenario：Given-When-Then 零翻译成测试
...
![三层不信任的强度递进](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/three-distrust.png)
...
![六条流程铁律](/assets/images/技术/编程/AI%20应用工程化/Harness%20Engineering/six-rules.png)
