---
layout: post
title: "理解 Agent 中的 Slash Command：从概念到 Hermes 自定义命令实践"
date:  2026-06-06 17:52:02 +0800
categories: ["技术", "编程", "AI应用工程化"]
tag: ["AI Agent", "Slash Command", "Hermes", "Agent 工程化"]
image:
  path: /assets/images/技术/编程/AI 应用工程化/理解 Agent 中的 Slash Command：从概念到 Hermes 自定义命令实践/cover.png
  alt: Slash Command 与 Hermes 自定义命令实践封面
---
...
| 用户输入 | Hermes 改写后 |
|---|---|
| `/wechat-gzh abc/def.md` | `/markdown-to-wechat-richtext abc/def.md` |
| `/wechat-gzh posts/a.md` | `/markdown-to-wechat-richtext posts/a.md` |
| `/wechat-gzh /home/sharpcj/blog/a.md` | `/markdown-to-wechat-richtext /home/sharpcj/blog/a.md` |
...
| `/markdown-to-wechat-richtext` | 加载并执行本地 Skill 工作流 |
...
|---|---|---|---|
| `exec` | 执行本地 shell 命令 | 通常不调用 | 固定输出、系统检查、脚本执行 |
| `alias` | 改写到另一个 Slash Command | 取决于目标命令 | 缩短命令名、包装 Skill、复用已有命令 |
